...
<form method="post">
<p><input type="submit" method="post" name="<?php echo $dipole; ?>" value="Associtation de deux dipôles( série, parallèle)" id="submit"/></p>
</form>
...
if(isset($_POST[$dipole]))
{
    $contenu=file_get_contents('./vue/Docs/physique/dipole.html');
}
...
{
    $contenu= file_get_contents('./vue/Docs/physique/impedance.html');
}
?>